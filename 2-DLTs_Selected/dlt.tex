...
\begin{defin}
Let $(V, Q)$ be a FBAS and $B \subseteq V$ be a set of nodes. We say that $B$ is a dispensible set or a \emph{\textbf{DSet}} iff:
\begin{packed_item1}
